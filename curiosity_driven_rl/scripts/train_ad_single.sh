...
export policy=/NEW_EDS/miaojw/projects/Pixel-Reasoner/output/md_sft_qwen25vl3b1109/checkpoint-200
...
export save_name="grpo-3b-1109"


# export rbuffer=256 # replay buffer size
# export bsz=128 # global train batch size
export rbuffer=128
export bsz=64
export evalsteps=1
export mbsz=1 
...
bash ./scripts/train_vlm_single2.sh