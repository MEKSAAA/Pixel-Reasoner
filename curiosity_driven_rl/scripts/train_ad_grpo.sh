...
export policy=/data9/data/miaojw/projects26/agentiad/sft_qwen25vl3b_0123/checkpoint-1000
export nvj_path="/NEW_EDS/miaojw/miniconda3_new42/envs/cur42/lib/python3.10/site-packages/nvidia/nvjitlink/lib"
export save_name="grpo-3b-all-reward"
...
export NCCL_ASYNC_ERROR_HANDLING=1
export NCCL_DEBUG=warn
# export GRPC_KEEPALIVE_TIME_MS=300000
# export GRPC_KEEPALIVE_TIMEOUT_MS=300000
# export GRPC_KEEPALIVE_PERMIT_WITHOUT_CALLS=1
# export GRPC_HTTP2_MAX_PINGS_WITHOUT_DATA=0
# export GRPC_HTTP2_MIN_RECV_PING_INTERVAL_WITHOUT_DATA_MS=300000

unset VLLM_ENFORCE_EAGER
unset VLLM_WORKER_DISABLE_CUDA_GRAPH
